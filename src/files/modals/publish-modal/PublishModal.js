      ...
      return (
        <div>
          ...
          <div className='flex center mb2 relative'>
            ...
            <div className='absolute h2 pl2 flex items-center' style={{ right: '4px', top: '50%', transform: 'translateY(-50%)', background: 'linear-gradient(90deg, rgba(15, 18, 22, 0.35), #0f1216 10%, #0f1216 100%)' }} >
              { copied
                ? <>
