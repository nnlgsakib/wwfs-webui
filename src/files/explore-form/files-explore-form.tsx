      ...
      <div data-id='FilesExploreForm' className='sans-serif black-80 flex'>
        <div className='flex-auto'>
          <div className='relative'>
            ...
            <small id='ipfs-path-desc' className='o-0 absolute f6 black-60 db mb2'>Paste in a CID or WWFS path</small>
          </div>
        </div>
        <div className='flex flex-row-reverse mb2'>
          ...
          <Button
            ...
            onClick={onBrowse}
            bg='bg-navy'
            className='ExploreFormButton button-reset pv1 ph2 ba f7 fw4 overflow-hidden tc' >
