...
const Tooltip = ({ t, bw, show, pos }) => {
  ...
  return (
    <div className='sans-serif absolute pa2 br3' style={{
      ...
      <div className='absolute' style={{
        ...
        width: '0',
        height: '0',
        borderTop: '20px solid #0f1216',
        borderRight: '20px solid transparent'
      }} />
      <div className='dt'>
        <div className='dt-row'>
          <span className='dtc f7 charcoal tr'>{t('app:terms.in').toLowerCase()}:</span>
          <span className='f4 ml1' style={{ color: '#8ab4ff' }}>{bw.in[0]}</span>
          <span className='f7' style={{ color: '#cbd5e1' }}>{bw.in[1]}/s</span>
        </div>
        <div className='dt-row'>
          <span className='dtc f7 charcoal tr'>{t('app:terms.out').toLowerCase()}:</span>
          <span className='f4 ml1' style={{ color: '#8ab4ff' }}>{bw.out[0]}</span>
          <span className='f7' style={{ color: '#cbd5e1' }}>{bw.out[1]}/s</span>
        </div>
      </div>
    </div>
  )
